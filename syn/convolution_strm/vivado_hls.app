<project xmlns="com.autoesl.autopilot.project" name="convolution_strm" top="filter_3x3_impulse_strm">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        ...
        <file name="../../../tb/main.cpp" sc="0" tb="1" cflags=" -I../../../inc  -I../../../tb  -DINPUT_SIZE_SMALL -DVERBOSE"/>
