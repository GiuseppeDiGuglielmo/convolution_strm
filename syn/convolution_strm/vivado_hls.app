<project xmlns="com.autoesl.autopilot.project" name="convolution_strm" top="top_convolution_strm">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        ...
        <file name="../../../tb/main.cpp" sc="0" tb="1" cflags=" -I../../../inc  -I../../../tb -DVERBOSE -DINPUT_SIZE_SMALL "/>
